...
def compute_surface_distances(mask_gt: np.array, mask_pred: np.array, spacing_mm: np.array) -> dict:
...
def compute_average_surface_distance(surface_distances: dict) -> (float, float):
...
def compute_surface_overlap_at_tolerance(surface_distances: np.array, tolerance_mm: np.array) -> (float, float):
...
def compute_surface_dice_at_tolerance(surface_distances: np.array, tolerance_mm: np.array) -> float:
...
def compute_dice_coefficient(mask_gt: np.array, mask_pred: np.array) -> float:
    ...
    dice_score = 2 * volume_intersect / volume_sum
    return dice_score
